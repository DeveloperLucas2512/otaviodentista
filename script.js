...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Carrossel
  document.addEventListener("DOMContentLoaded", function () {
    // Adiciona funcionalidade ao botão Saiba Mais
    ...
    saibaMaisBtns.forEach((btn) => {
      btn.addEventListener("click", function () {
        ...
        const expandableContent = document.getElementById(
          `conteudo-${contentId}`
        );
  ...
  var contentData = {
    ...
    3: `
     <h2>Excesso Vertical de Maxila</h2>
      < problema pode resultar em um perfil facial desproporcional, onde a parte superior da face parece exageradamente alongada em comparap>O excesso vertical de maxila é uma condição onde há um aumento anormal no comprimento da maxila, a parte superior do maxilar. Esteção com a parte inferior.</p>
